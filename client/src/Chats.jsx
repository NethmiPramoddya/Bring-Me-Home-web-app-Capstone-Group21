...
function Chats({ socket, username, room }) {
  ...
  return (
    <div className="chat-window">
      <div className="px-4 py-2 mt-10 ml-10 mr-10 text-white bg-gray-800 chat-header">
        <p>Live chat</p>
      </div>

      {/*  Chat body scrollable, displays messages */}
      <div className="chat-body h-[400px] border border-gray-800 bg-white p-0 ml-10 mr-10 overflow-hidden">
      ...
      <div className="flex h-10 mb-10 ml-10 mr-10 border-t border-gray-800 chat-footer">
        <input
          type="text"
          placeholder="Hey.."
